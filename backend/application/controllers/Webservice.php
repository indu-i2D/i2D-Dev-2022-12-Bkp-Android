...
class Webservice extends REST_Controller {
	...
	{
		$result = $this->webservice->braintree_client_token($this->Getjson);
		$this->set_response($result);
	}
	...
	/*Keys*/
	public function twitter_meta_post()
	{
	    var_dump('das');
		$result = $this->webservice->twitter_meta($this->Getjson);
		$this->set_response($result);
	}
	
	public function google_meta_post()
	{
		$result = $this->webservice->google_meta($this->Getjson);
		$this->set_response($result);
	}
	
	public function facebook_meta_post()
	{
		$result = $this->webservice->facebook_meta($this->Getjson);
		$this->set_response($result);
	}
	
	public function paypal_meta_post()
	{
		$result = $this->webservice->paypal_meta($this->Getjson);
		$this->set_response($result);
	}
	
	public function braintree_meta_post()
	{
		$result = $this->webservice->braintree_meta($this->Getjson);
		$this->set_response($result);
	}
