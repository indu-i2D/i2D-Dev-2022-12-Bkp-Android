 ...
 */
public class UnitesStateLocationAdapterList extends RecyclerView.Adapter<UnitesStateLocationAdapterList.MyViewHolder> {
    ...
    public UnitesStateLocationAdapterList(Activity mContext, List<HashMap<String, String>> charitylist) {
        this.mContext = mContext;
        this.charitylist = charitylist;
        Log.e("charitylist", "" + charitylist);
    }

    public UnitesStateLocationAdapterList(NameSearchActivity mContext, ArrayList<Charitylist> charitylist1) {
        this.mContext = mContext;
