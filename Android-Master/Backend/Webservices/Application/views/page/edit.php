                            ...
                            <div class="card-body">
                                ...
                                <form action="" id="page" name="page" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="title" id="title" value="<?php echo $pages[DB_prefix."TITLE"]; ?>" readonly="">
                                    </div>
                                    <div class="form-group">
                                        <label for="example-text-input" class="col-form-label">Description</label>
                                        <textarea class="editor form-control" name='content' id="content"><?php echo $pages[DB_prefix."DESCRIPTION"]; ?></textarea>
                                    </div>
