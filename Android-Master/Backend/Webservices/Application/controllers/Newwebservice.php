...
class Newwebservice extends REST_Controller {
	...
	public function change_password_post()
	{
	 ...
	 public function new_transaction_post()
	{
	
	    $result = $this->webservice->new_transaction($this->Getjson);
		$this->set_response($result);
	}
