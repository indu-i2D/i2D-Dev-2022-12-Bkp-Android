...
abstract class REST_Controller extends CI_Controller {
     ...
     protected function _log_response($response="")
    {
        ...
        return $this->rest->db->update($this->config->item('rest_logs_table'), $log_data);
    }
     ...
     */
    public function response_new($data = array(), $http_code = null,  $continue = FALSE)
    {
    ...
    public function set_response($data = NULL, $http_code = NULL)
    {
     ...
     public function set_response1($data = NULL, $http_code = NULL)
    {
        $this->response_new($data, $http_code, TRUE);
    }
    ...
    protected function _log_request($authorized = FALSE)
    {
        ...
        $is_inserted = $this->rest->db
            ->insert(
                ...
                'device_id' => !empty($this->input->get('device_id')) ? $this->input->get('device_id') : '',
